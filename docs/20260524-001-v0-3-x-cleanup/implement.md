...
- [x] task-003: `DESIGN.md` / `ROADMAP.md` 제거 및 `CLAUDE.md` 설계 문서 섹션 정리
...
- [x] task-001: `DESIGN.md` Translations 예시 스키마 동기화
...
- [x] task-002: `.gitignore`에 module-root stray binary 패턴 추가
