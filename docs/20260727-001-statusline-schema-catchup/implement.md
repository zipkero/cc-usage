...
- [ ] task-001: 컨텍스트 퍼센트·토큰 표시를 input 계열로 정합
...
- [ ] task-002: 모델 기호 매핑을 표로 바꾸고 fable·mythos 계열 추가
...
- [ ] task-009: COLUMNS 기준 줄 맞춤과 표시폭 계산 도입
